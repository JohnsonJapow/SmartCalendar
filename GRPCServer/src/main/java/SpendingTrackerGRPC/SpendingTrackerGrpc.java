...
public final class SpendingTrackerGrpc {
  ...
  public static final String SERVICE_NAME = "extrasmart.SpendingTracker";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<SpendingTrackerGRPC.TransactionRequest,
      SpendingTrackerGRPC.TransactionResponse> getRecordTransactionMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "RecordTransaction",
      requestType = SpendingTrackerGRPC.TransactionRequest.class,
      responseType = SpendingTrackerGRPC.TransactionResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<SpendingTrackerGRPC.TransactionRequest,
      SpendingTrackerGRPC.TransactionResponse> getRecordTransactionMethod() {
    io.grpc.MethodDescriptor<SpendingTrackerGRPC.TransactionRequest, SpendingTrackerGRPC.TransactionResponse> getRecordTransactionMethod;
      ...
      synchronized (SpendingTrackerGrpc.class) {
        if ((getRecordTransactionMethod = SpendingTrackerGrpc.getRecordTransactionMethod) == null) {
          SpendingTrackerGrpc.getRecordTransactionMethod = getRecordTransactionMethod = 
              io.grpc.MethodDescriptor.<SpendingTrackerGRPC.TransactionRequest, SpendingTrackerGRPC.TransactionResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(
                  "extrasmart.SpendingTracker", "RecordTransaction"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  SpendingTrackerGRPC.TransactionRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  SpendingTrackerGRPC.TransactionResponse.getDefaultInstance()))
  ...
  public static abstract class SpendingTrackerImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<SpendingTrackerGRPC.TransactionRequest> recordTransaction(
        io.grpc.stub.StreamObserver<SpendingTrackerGRPC.TransactionResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncBidiStreamingCall(
              new MethodHandlers<
                SpendingTrackerGRPC.TransactionRequest,
                SpendingTrackerGRPC.TransactionResponse>(
  ...
  private static abstract class SpendingTrackerBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return SpendingTrackerGRPC.SmartServiceImpl.getDescriptor();
    }
