...
public final class ScheduleOptimizerGrpc {
  ...
  public static final String SERVICE_NAME = "extrasmart.ScheduleOptimizer";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<ScheduleOptimizerGRPC.Goal,
      ScheduleOptimizerGRPC.GoalResponse> getSetChallengeMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SetChallenge",
      requestType = ScheduleOptimizerGRPC.Goal.class,
      responseType = ScheduleOptimizerGRPC.GoalResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<ScheduleOptimizerGRPC.Goal,
      ScheduleOptimizerGRPC.GoalResponse> getSetChallengeMethod() {
    io.grpc.MethodDescriptor<ScheduleOptimizerGRPC.Goal, ScheduleOptimizerGRPC.GoalResponse> getSetChallengeMethod;
      ...
      synchronized (ScheduleOptimizerGrpc.class) {
        if ((getSetChallengeMethod = ScheduleOptimizerGrpc.getSetChallengeMethod) == null) {
          ScheduleOptimizerGrpc.getSetChallengeMethod = getSetChallengeMethod = 
              io.grpc.MethodDescriptor.<ScheduleOptimizerGRPC.Goal, ScheduleOptimizerGRPC.GoalResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "extrasmart.ScheduleOptimizer", "SetChallenge"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ScheduleOptimizerGRPC.Goal.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ScheduleOptimizerGRPC.GoalResponse.getDefaultInstance()))
  ...
  public static abstract class ScheduleOptimizerImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void setChallenge(ScheduleOptimizerGRPC.Goal request,
        io.grpc.stub.StreamObserver<ScheduleOptimizerGRPC.GoalResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                ScheduleOptimizerGRPC.Goal,
                ScheduleOptimizerGRPC.GoalResponse>(
  ...
  public static final class ScheduleOptimizerBlockingStub extends io.grpc.stub.AbstractStub<ScheduleOptimizerBlockingStub> {
    ...
    /**
     */
    public ScheduleOptimizerGRPC.GoalResponse setChallenge(ScheduleOptimizerGRPC.Goal request) {
  ...
  public static final class ScheduleOptimizerFutureStub extends io.grpc.stub.AbstractStub<ScheduleOptimizerFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<ScheduleOptimizerGRPC.GoalResponse> setChallenge(
        ScheduleOptimizerGRPC.Goal request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SET_CHALLENGE:
          serviceImpl.setChallenge((ScheduleOptimizerGRPC.Goal) request,
              (io.grpc.stub.StreamObserver<ScheduleOptimizerGRPC.GoalResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class ScheduleOptimizerBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return ScheduleOptimizerGRPC.SmartServiceImpl.getDescriptor();
    }
